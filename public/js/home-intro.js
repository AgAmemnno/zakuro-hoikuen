	...
	create(){
		...
		if( this.COMP){
		    ...
		    if(GUION){
				...
				bloomFolder.add( effectController , 'eB_threshold', 0.0, 1.0 ).onChange( function ( value ) {
					post.effectBloom.threshold = Number( value );
				} );
				
				bloomFolder.add( effectController , 'eB_strength', 0.0, 3.0 ).onChange( function ( value ) {
...
function init0() {
                ...
                function _init() {
                    ...
                    loader.load( 'models/gocchaman2.obj', function ( object ) {
                    ...
                    loader.load( 'models/female02/female02.obj', function ( object ) {
